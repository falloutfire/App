...
public class Question {
    ...
    private static final ArrayList<Question> questions = new ArrayList<>(Arrays.asList(
            ...
            //new Question(20, "Картина в стиле «модерн» «Поцелуй». Кто автор?", new String[]{"Густав Климт","Артур Макмердо","Клод Моне", "Уильям Моррис"}, 0, "Колизей является памятником архитект",R.drawable.anskiss)
