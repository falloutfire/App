...
public class Question {
    ...
    private static final ArrayList<Question> questions = new ArrayList<>(Arrays.asList(new Question(0, "Что является лишним в ряду?", new String[]{"Лувр","Колизей", "Эрмитаж", "Третьяковская галерея"}, 1, "Колизей является памятником архитектуры. Все остальные сооружения – ныне действующие музеи"),
            ...
            new Question(16, "Картина «Актриса Маргарита». Кто автор?", new String[]{"Майкова Любовь Михайловна","Медведева Екатерина Ивановна ", "Анри Руссо", "Нико Пиросмани"}, 3, "Нико Пиросмани впервые увидел ее на афише и влюбился. Потрет женщины, к ногам которой Нико Пиросмани бросил «миллион алых роз»", R.drawable.ansmargarita),
