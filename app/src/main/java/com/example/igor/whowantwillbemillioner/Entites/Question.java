...
public class Question {
    ...
    private static final ArrayList<Question> questions = new ArrayList<>(Arrays.asList(
            ...
            new Question(16, "Картина в стиле «модерн» «Поцелуй». Кто автор?", new String[]{"Густав Климт", "Артур Макмердо", "Клод Моне", "Уильям Моррис"}, 0, "Колизей является памятником архитект", R.drawable.anskiss)
            //new Question(id: 20, "Что является лишним в ряду?", new String[]{"Майкова Любовь Михайловна ","1345", "1242", "1234"}, 0, "Колизей является памятником архитект"),
